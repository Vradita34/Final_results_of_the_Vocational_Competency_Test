                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control" placeholder="Title" name="title" value="{{old('title',$book->title)}}">
                                        </div>
                                        @error('title')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="last-name-column" class="form-control" placeholder="Release_date" name="release_date" value="{{date('Y-m-d',strtotime($book->release_date))}}">
                                        </div>
                                        @error('release_date')
                                        <p class="text-warning">{{$message}}</p>
                                        @enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" max="30" id="last-name-column" class="form-control" placeholder="Read Duration" name="read_duration" value="{{old('read_duration',$book->read_duration)}}">
                                        </div>
                                        @error('read_duration')
                                        <p class="text-warning">{{$message}}</p>
                                        @enderror
